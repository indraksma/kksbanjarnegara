<section class="px-5 py-10 bg-gray-100 dark:bg-[#171717] text-gray-800 dark:text-gray-100">
	<div class="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
		...
		<div class="hidden py-2 xl:col-span-3 lg:col-span-4 md:hidden lg:block">
            <!-- Tabs using Preline and Tailwind -->
            <div class="mb-8 border-b-2 border-opacity-10 border-violet-400 dark:border-violet-600">
                <nav class="flex space-x-5" aria-label="Tabs" role="tablist">
                    <button type="button"
                        id="news-tab-latest"
                        class="pb-5 text-xs font-bold uppercase  hs-tab-active:text-violet-600 hs-tab-active:dark:text-violet-600 hs-tab-active:border-violet-400 hs-tab-active:dark:border-violet-600 cursor-pointer"
                        data-hs-tab="#news-tabpanel-latest"
                    ...
                    <button type="button"
                        id="news-tab-popular"
                        class="pb-5 text-xs font-bold uppercase  hs-tab-active:text-violet-600 hs-tab-active:dark:text-violet-600 hs-tab-active:border-violet-400 hs-tab-active:dark:border-violet-600 cursor-pointer"
                        data-hs-tab="#news-tabpanel-popular"
                        aria-controls="news-tabpanel-popular"
                        role="tab"
                        aria-selected="false">
                        Popular
                    </button>
            ...
            <div>
                ...
                <div id="news-tabpanel-popular" class="hidden" role="tabpanel" aria-labelledby="news-tab-popular">
                    <!-- Popular tab content goes here -->
                    <div class="flex flex-col divide-y divide-gray-700 dark:divide-gray-300">
                        <!-- Example popular news items -->
                        <div class="flex px-1 py-4">
                            <img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-gray-500 dark:bg-gray-500" src="https://source.unsplash.com/random/248x328">
                            <div class="flex flex-col flex-grow">
                                <a rel="noopener noreferrer" href="#" class="font-serif hover:underline">Popular news headline 1</a>
                                <p class="mt-auto text-xs ">1 hour ago
                                    <a rel="noopener noreferrer" href="#" class="block text-blue-400 dark:text-blue-600 lg:ml-2 lg:inline hover:underline">Trending</a>
                                </p>
                            </div>
                        </div>
                        <div class="flex px-1 py-4">
                            <img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-gray-500 dark:bg-gray-500" src="https://source.unsplash.com/random/249x329">
                            <div class="flex flex-col flex-grow">
                                <a rel="noopener noreferrer" href="#" class="font-serif hover:underline">Popular news headline 2</a>
                                <p class="mt-auto text-xs ">2 hours ago
                                    <a rel="noopener noreferrer" href="#" class="block text-blue-400 dark:text-blue-600 lg:ml-2 lg:inline hover:underline">Popular</a>
                                </p>
                            </div>
                        </div>
			...
			<div class="flex flex-col divide-y divide-gray-700 dark:divide-gray-300">
				<div class="flex px-1 py-4">
					<img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-gray-500 dark:bg-gray-500" src="https://source.unsplash.com/random/244x324">
					<div class="flex flex-col flex-grow">
						...
						<p class="mt-auto text-xs ">5 minutes ago
							<a rel="noopener noreferrer" href="#" class="block text-blue-400 dark:text-blue-600 lg:ml-2 lg:inline hover:underline">Politics</a>
						</p>
					</div>
				</div>
				<div class="flex px-1 py-4">
					<img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-gray-500 dark:bg-gray-500" src="https://source.unsplash.com/random/245x325">
					<div class="flex flex-col flex-grow">
						<a rel="noopener noreferrer" href="#" class="font-serif hover:underline">Nulla consectetur efficitur.</a>
						<p class="mt-auto text-xs ">14 minutes ago
							<a rel="noopener noreferrer" href="#" class="block text-blue-400 dark:text-blue-600 lg:ml-2 lg:inline hover:underline">Sports</a>
						</p>
					</div>
				</div>
				<div class="flex px-1 py-4">
					<img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-gray-500 dark:bg-gray-500" src="https://source.unsplash.com/random/246x326">
					<div class="flex flex-col flex-grow">
						<a rel="noopener noreferrer" href="#" class="font-serif hover:underline">Vitae semper augue purus tincidunt libero.</a>
						<p class="mt-auto text-xs">22 minutes ago
							<a rel="noopener noreferrer" href="#" class="block text-blue-400 dark:text-blue-600 lg:ml-2 lg:inline hover:underline">World</a>
						</p>
					</div>
				</div>
				<div class="flex px-1 py-4">
					<img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 bg-gray-500 dark:bg-gray-500" src="https://source.unsplash.com/random/247x327">
					<div class="flex flex-col flex-grow">
						<a rel="noopener noreferrer" href="#" class="font-serif hover:underline">Suspendisse potenti.</a>
						<p class="mt-auto text-xs ">37 minutes ago
							<a rel="noopener noreferrer" href="#" class="block text-blue-400 dark:text-blue-600 lg:ml-2 lg:inline hover:underline">Business</a>
						</p>
					</div>
				</div>
			</div>
