        ...
        <template x-for="(berita, index) in beritas" :key="index">
            ...
            >
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent p-6 flex flex-col justify-end">
                    <span class="inline-flex px-3 py-1 bg-orange-500 text-white text-xs font-semibold rounded mb-2 w-fit" x-text="berita.kategori"></span>

                    <h2 class="text-white text-xl md:text-2xl font-bold leading-snug" x-text="berita.judul"></h2>
                    <a href="{{ route('news.detail') }}" wire:navigate class="mt-4 inline-flex items-center gap-2 text-white text-sm hover:underline">
